...
def get_ticker(coin1='btc', coin2='usd'):
    # response = requests.get(url='https://yobit.net/api/3/ticker/ltc_btc-eth_btc-xrp_btc?ignore_invalid=1')
...
def get_depth(coin1="btc", coin2="usd", limit=150):
    ...
    return f"Total_bids: {total_bids_amount} $"
...
def main():
    ...
    # print(get_depth(coin1='btc', limit=2000))
    print(get_trades())
